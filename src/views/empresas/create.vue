...
<div class="container">
   ...
   <h1 style="text-align: center;">Crear empresa</h1>
    ...
    <div class="form-group row">
      ...
      <div>
      <input class="form-control col-lg-14" type="text" v-model="empresa.nombre" id="nombre" />
      </div>
    </div>
    <div class="form-group row">
...
>>>>>>> e2b5d00f1aedc055026506231160f754f7d47c0a
    ...
    <div class="form-group row">
      ...
      <div>
      <input class="form-control col-lg-14" type="text" v-model="empresa.nit" id="nit" />
      </div>
    </div>
    <div class="form-group row">
      <label for="direccion_empresa" class="col-lg-4 control-label">Dirección</label>
      <div>
      <input
    ...
    <div class="form-group row">
      ...
      <div>
      <input class="form-control col-lg-14" type="text" v-model="empresa.ciudad_empresa" id="ciudad_empresa" />
      </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div>
      <input style="margin-left:2.5rem; " class="form-control col-lg-14" type="file" @change="obtenerImagen" id="logo" />
      </div>
      <figure>
